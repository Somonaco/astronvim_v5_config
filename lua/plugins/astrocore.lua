  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        -- lsp
        ["<Leader>lc"] = { "<cmd>lua vim.lsp.buf.incoming_calls()<CR>", desc = "My Open call hierarchy" },
        ["<Leader>lo"] = { "<cmd>lua vim.lsp.buf.outgoing_calls()<CR>", desc = "My Outgoing calls" },
        ["<Leader>ld"] = { "<cmd>lua vim.lsp.buf.declaration()<CR>", desc = "My Goto declaration" },
        ["<Leader>li"] = { "<cmd>lua vim.lsp.buf.implementation()<CR>", desc = "My Show implementation" },
        ["<Leader>lr"] = { "<cmd>lua vim.lsp.buf.references()<CR>", desc = "My Show refrences" },
        ["<C-8>"] = { "<cmd>lua vim.lsp.buf.hover()<CR>", desc = "My Hover" },
        -- clang
